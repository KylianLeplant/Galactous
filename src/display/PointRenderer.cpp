...
unsigned int PointRenderer::compileShader(const char* source, GLenum type) {
...
PointRenderer::PointRenderer() : camera() {
...
void PointRenderer::drawPoint(float x, float y, float z, float r, float g, float b) {
