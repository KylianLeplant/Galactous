...
SOURCES = $(SRC_DIR)/types.cpp $(SRC_DIR)/Octree.cpp $(SRC_DIR)/Particle.cpp $(SRC_DIR)/Galaxy.cpp $(SRC_DIR)/GalaxyFactory.cpp $(SRC_DIR)/display/Window.cpp $(SRC_DIR)/display/Page.cpp $(SRC_DIR)/display/Input.cpp $(SRC_DIR)/display/Renderer.cpp $(SRC_DIR)/display/Camera.cpp $(SRC_DIR)/simulation/Simulation.cpp
MAIN_OBJECT = $(TARGET_DIR)/main.o
OBJECTS = $(TARGET_DIR)/types.o $(TARGET_DIR)/Octree.o $(TARGET_DIR)/Particle.o $(TARGET_DIR)/Galaxy.o $(TARGET_DIR)/GalaxyFactory.o $(TARGET_DIR)/glad.o $(TARGET_DIR)/Window.o $(TARGET_DIR)/Page.o $(TARGET_DIR)/Simulation.o $(TARGET_DIR)/ComputeShader.o $(TARGET_DIR)/Input.o $(TARGET_DIR)/Camera.o $(TARGET_DIR)/Renderer.o
...
$(TARGET_DIR)/Renderer.o: $(SRC_DIR)/display/Renderer.cpp
	@mkdir -p $(TARGET_DIR)
	$(CXX) -c $(ALL_INCLUDES) $(SRC_DIR)/display/Renderer.cpp -o $(TARGET_DIR)/Renderer.o $(CXXFLAGS)
...
clean:
	rm -f $(TARGET_DIR)/main.o $(TARGET_DIR)/types.o $(TARGET_DIR)/Octree.o $(TARGET_DIR)/Particle.o $(TARGET_DIR)/Galaxy.o $(TARGET_DIR)/Window.o $(TARGET_DIR)/Page.o $(EXECUTABLE) $(TARGET_DIR)/Renderer.o $(TARGET_DIR)/Camera.o
